        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Originally from 🇮🇪, based in 🇳🇱,  I'm a versatile web professional and with over 13 years experience developing, scaling and optimising large scale websites and applications. My current favourite tools/weapons of choice: Next JS/React (Typescript) Craft CMS, WordPress, Shopify, Laravel, Pocketbase, React Native, Node JS and Tailwind...to name but a few.</p>

        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">I am an experienced Web Developer, Manager, Tech Lead, CTO, Consultant and Cat-Valet. For over a decade, I have been honing my web development and team building/management skills, whilst working 
              ...
              <br /><br />
              But to cut a long story short, I'm all about building websites! I'm a huge proponent of headless development and an ardent supporter of the mighty <a href="https://www.liverpoolfc.com/" className="text-red-700" target="_blank">Liverpool FC</a>.  
            </p>
          </div>
